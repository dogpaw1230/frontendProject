...
// $('.bus_nav_ul li:nth-child(4n)').css({
//     marginRight : '0'
// })

    /* 질문

        1. css 파일 안에 class를 다 만들어놓고, 위처럼 for 문을 사용해 li 요소를 생성하는 것
        2. for 문 사용하여 요소 생성 후 각 요소를 잡아서 필요한 css를 먹이는 것
...
$('#p2').hover(function() {
    ...
    $('#p1').css({
        color: 'white',
        backgroundColor: 'rgba(64, 127, 71, 1)',
